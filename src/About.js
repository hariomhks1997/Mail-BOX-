...
const About = () => {
  return (
    <div style={{color:'black',textAlign:'center',background:'white',height:'auto',marginTop:'0.5rem',padding:'8rem',fontSize:'30px'}}>
        <header style={{background:'pink',fontSize:'50px',}}>The Generics</header>
        <h3>About</h3>
        <p>About
